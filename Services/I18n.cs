...
public static class I18n
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _strings = new()
    {
        ["zh-TW"] = new()
        {
            ...
            ["TrayShow"] = "顯示",
            ["TrayExit"] = "結束",
            ["TranscriptPlaceholder"] = "轉錄文字將顯示在這裡...",
            ["TranscriptCopied"] = "已複製!",
            ["HistoryTooltip"] = "歷史紀錄",
            ["HistoryRefresh"] = "重新整理",
            ["HistoryClear"] = "清除紀錄",
            ["HistoryClearConfirm"] = "確定要清除所有歷史紀錄嗎？",
            ["HistoryEmpty"] = "(尚無紀錄)",
            ["SettingsConvertToTraditional"] = "簡體自動轉換為繁體",
        ...
        ["en-US"] = new()
        {
            ...
            ["HistoryTooltip"] = "History Log",
            ["HistoryRefresh"] = "Refresh",
            ["HistoryClear"] = "Clear History",
            ["HistoryClearConfirm"] = "Are you sure you want to clear all history?",
            ["HistoryEmpty"] = "(No history yet)",
            ["SettingsConvertToTraditional"] = "Auto-convert to Traditional Chinese",
